...
#include "FloatingCylinderActor.h"

// Sets default values
AFloatingCylinderActor::AFloatingCylinderActor()
{
...
void AFloatingCylinderActor::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AFloatingCylinderActor::Tick(float DeltaTime)
{
